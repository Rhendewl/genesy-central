// DELETE /api/workspace/tasks/[id]/attachments/[attachmentId]
...
export async function DELETE(_req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const { error } = await supabase.from("workspace_task_attachments").delete().eq("id", attachmentId).eq("task_id", id);
